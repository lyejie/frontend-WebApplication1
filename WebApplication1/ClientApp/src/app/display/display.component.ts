...
export class DisplayComponent implements OnInit {
  ...
  employees: string[];
  ngOnInit() {
    this.httpClient.get("https://localhost:44371/api/employeescontroller/").
      subscribe(
        data => {
  ...
  //    return this.httpClient.get<any[]>("https://localhost:44371/api/employeescontroller/GetEmployee");
  //      }
  //}
